...
window.onload = function () {
    ...
    document.querySelector('#viewAllButton').onclick = function () {
        viewAllParks();
    }
}
}
...
function searchParks() {
    ...
    const filteredParks = nationalParksArray.filter(park => {
        const locationMatch = park.State.toLowerCase() === stateInput;
        const parkTypeMatch = park.LocationName.toLowerCase().includes(parkTypeInput);
